...
//        LoginController loginController = new LoginController(sib);
//        LoginViewModel loginViewModel = new LoginViewModel();
//        ViewManagerModel viewManagerModel = new ViewManagerModel();
//        CancelController cancelController = new CancelController(loginViewModel,viewManagerModel);
//        JPanel loginView = new LoginView(loginViewModel, loginController, cancelController);
...
//        LabelTextPanel panel = (LabelTextPanel) loginView;
...
//        System.out.println("view-model: " + loginViewModel.getState().getPassword());
//
